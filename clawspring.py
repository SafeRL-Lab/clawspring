...
"""
        ...
        try:
            for i in range(8):
                ...
                sys.stdout.write(f"\r  {clr(frame, 'cyan', 'bold')} Initializing Andromeda...")
                sys.stdout.flush()
                time.sleep(0.12)
        ...
        print(clr("  ╭─ ", "dim") + clr("Andromeda ", "cyan", "bold") + ver_clr + clr(" ─────────────────────────────────╮", "dim"))
